...
class Tools {
    ...
    static let containsStringTool = Tool(
        ...
        description: "Find words containing a specified string of letters. The letters must appear consequtively and in the original order within the returned words.",
    ...
    static let containsOnlyTool = Tool(
        ...
        description: "Find words by which contain exclusively letters form the specified list.",
    ...
    static let containsAtLeastTool = Tool(
        ...
        description: "Find words by which must contain at least the specified set of letters, but may contain others.",
