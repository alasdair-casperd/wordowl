...
extension Tool {
    ...
    static let containsLettersTool = Tool(
        name: "Contains Rearranged",
        shortName: "Contains Rearranged",
        description: "Search for words which contain all of the letters in your input, rearranged.",
        shortDescription: "Search for words which containing rearranged letters.",
        searchFunction: containsLetters,
